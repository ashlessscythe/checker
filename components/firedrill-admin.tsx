              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <div className="mt-1 text-sm text-gray-700 dark:text-gray-200">
                    Present: <b>{computed.presentCount}</b> · Accounted:{" "}
                    <b>{computed.accountedCount}</b> · Unaccounted:{" "}
                    <b>{computed.unaccountedCount}</b>
                  </div>
                </div>
                  ...
                  {recipients
                    ...
                    .map((r) => {
                      ...
                      return (
                        <label
                          key={r.id}
                          className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-2 py-1 text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                        >
                          <input
                            type="checkbox"
                            checked={checked}
                          ...
                          <span>{email}</span>
                          {r.isActive ? (
                            <span className="rounded bg-green-100 px-1.5 py-0.5 text-xs text-green-700 dark:bg-green-900/40 dark:text-green-200">
                              active
                            </span>
                          ) : (
                            <span className="rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600 dark:bg-gray-900/40 dark:text-gray-300">
                              inactive
                            </span>
                          )}
                        </label>
